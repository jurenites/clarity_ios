...
//    _igDocController.annotation = [NSDictionary dictionaryWithObjectsAndKeys:[self titleWithText], @"InstagramCaption", nil];
...
- (BOOL)copyToClopBoardImpl
{
    ...
    return clipboardItems.count > 0;
}

- (void)copyToClopBoard
{
    if ([self copyToClopBoardImpl]) {
